...
export const metadata: Metadata = createSeoMetadata({
  ...
  description:
    "Professional AI-centric platform showcasing automated income software, pricing, dashboards, demos, and trust pages. Demo / Simulation Preview Only.",
  path: "/",
});
  ...
  return (
    <div className="w-full">
          ...
          <div className="scene-3d grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
            <div className="glass-surface neon-outline hover-tilt relative rounded-3xl p-8 md:p-10">
              <div className="flex flex-wrap items-center gap-3">
                <CountdownPill />
                <span className="rounded-full border border-white/10 bg-black/40 px-4 py-2 text-xs text-zinc-200">
                  Demo / Simulation Preview Only
                </span>
              </div>

              <h1 className="mt-6 text-4xl font-semibold tracking-tight text-white md:text-5xl">
                AIPROFITGEN – Automated Money Making Software
              </h1>
              <p className="mt-4 max-w-3xl text-sm leading-7 text-zinc-200">
                Futuristic AI-centric platform showcasing multiple products, pricing
                widgets, trust pages, and an interactive dashboard experience.
              </p>
      ...
      <div className="mx-auto w-full max-w-6xl px-6 py-14">
          ...
          <div className="flex items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-2 text-sm text-zinc-300">
                Explore every software product with premium UX and clear CTAs.
              </p>
            </div>
            <Link
              href="/products"
        ...
        <section className="glass-surface neon-outline hover-tilt mt-12 rounded-3xl p-10">
          <h2 className="text-2xl font-semibold text-white">CTA</h2>
          <div className="mt-4 grid gap-2 text-sm text-zinc-200">
            <div>Buy Software</div>
