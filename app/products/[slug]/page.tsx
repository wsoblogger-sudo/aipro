...
export async function generateMetadata({
  ...
  return createSeoMetadata({
    title: `${tool.name} — AIProfitGen Software`,
    description:
      "Software page with interface showcase, interactive demo, features, pricing, video showcase, testimonials, and CTAs. Demo / Simulation Preview Only.",
    ...
    <div className="mx-auto w-full max-w-6xl px-6 py-14">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          <div className="glass-surface rounded-3xl p-6">
            ...
            <div className="mt-2 text-sm leading-6 text-zinc-300">
              Glass UI, depth layers, and subtle parallax motion.
            </div>
          </div>
          <div className="glass-surface rounded-3xl p-6">
            <div className="text-sm font-semibold text-white">Interactive demo</div>
            <div className="mt-2 text-sm leading-6 text-zinc-300">
              Demo terminal logs and simulated charting.
            </div>
          </div>
          <div className="glass-surface rounded-3xl p-6">
            <div className="text-sm font-semibold text-white">License workflow</div>
            <div className="mt-2 text-sm leading-6 text-zinc-300">
              Locked cards, UUID license keys, expiration UI, and billing history.
            </div>
          </div>
          <div className="glass-surface rounded-3xl p-6">
            <div className="text-sm font-semibold text-white">Support & tutorials</div>
            <div className="mt-2 text-sm leading-6 text-zinc-300">
              Dashboard includes tutorials and a support ticket UI.
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mt-12">
        ...
        <p className="mt-2 text-sm text-zinc-300">
          Pricing experience with hover effects and clear comparison.
        </p>
        <div className="mt-6 grid gap-6 lg:grid-cols-2">
          <div className="glass-surface rounded-3xl p-8">
            <div className="text-sm font-semibold text-white">Payment options</div>
          ...
          {isWidget ? (
            <WidgetCheckout toolId={tool.id as ToolId} />
          ) : (
            <div className="glass-surface rounded-3xl p-8">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <Link
                  href={pricingHref(tool.id as ToolId)}
                  className="rounded-xl bg-white px-5 py-2.5 text-sm font-semibold text-black hover:bg-zinc-200"
                >
                  Upgrade Tool Access
                </Link>
