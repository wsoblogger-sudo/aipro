...
export const metadata: Metadata = createSeoMetadata({
  title: "Ethercraft Pro Pricing — AI Trading Software Widget",
  description:
    "Ethercraft Pro pricing widget integration to unlock AI trading software previews, automated income dashboard access, billing history view, and license manager.",
        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-3xl text-sm leading-6 text-zinc-300">
              Widget-based pricing flow + dashboard unlock simulation.
            </p>
