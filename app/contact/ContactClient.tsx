...
export default function ContactClient() {
  ...
  const mailto = `mailto:support@aiprofitgen.com?subject=${encodeURIComponent(
    ...
    <div className="grid gap-8">
      <div className="glass-surface neon-outline rounded-3xl p-10">
        ...
        <p className="mt-4 max-w-3xl text-sm leading-7 text-zinc-200">
          Form submission (mailto), email, and WhatsApp.
        </p>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="glass-surface rounded-3xl p-8">
          ...
          <div className="mt-4 grid gap-3 text-sm text-zinc-300">
            ...
            <div className="glass-surface rounded-3xl p-6">No backend in this demo.</div>
          </div>
        </div>
      </div>
    </div>
